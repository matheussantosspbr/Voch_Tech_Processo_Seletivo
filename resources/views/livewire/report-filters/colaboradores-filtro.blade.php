    ...
    <div class="flex flex-col items-start mt-4">
        <div class="flex flex-row mb-4">
            ...
            <div class="flex flex-col w-64 ml-4">
                ...
                <input wire:model="filter.field_email" type="email" class="mt-2 w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-2.5 dark:bg-[#262626] dark:border-neutral-700  dark:text-white" placeholder="example@example.com" required>
            </div>
            <div class="flex flex-col w-64 ml-4">
                <label for="">CPF</label>
                <input wire:model="filter.field_cpf" type="text" class="mt-2 w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-2.5 dark:bg-[#262626] dark:border-neutral-700  dark:text-white" placeholder="00000000000" required>
            </div>
        </div>
        <div class="flex flex-row items-center justify-between">
            <div class="flex flex-col w-64">
                <label for="">ID da unidade</label>
